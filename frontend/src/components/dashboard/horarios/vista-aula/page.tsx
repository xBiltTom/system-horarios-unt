    ...
    <div className="space-y-10 pb-20">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-6 border-b border-[#0A192F]/10 dark:border-white/10 mb-8 mx-4 sm:mx-6 lg:mx-8 mt-6">
        <div>
          ...
          <h1 className="text-3xl font-black text-[#0A192F] dark:text-white tracking-tight">Ocupación de Ambientes</h1>
        </div>
        {periodoActivo && (
      ...
      {!ambienteSeleccionado ? (
        ...
        <div className="bg-white dark:bg-[#0A192F] rounded-2xl shadow-xl border border-gray-100 dark:border-[#112240] overflow-hidden animate-in zoom-in-95 fade-in duration-500 ease-out">
          {periodoActivo ? (
